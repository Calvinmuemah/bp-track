...
function LandingPage() {
  ...
  return (
    <div className="bg-primary min-vh-100 text-white">
      ...
      <nav className="navbar navbar-expand-lg bg-primary px-4 shadow-sm">
        <div className="container-fluid">
          ...
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav align-items-end ms-auto text-end">
              ...
              <li className="nav-item">
                <button 
                  className="btn btn-outline-light ms-3 border-2 text-dark"
      ...
      {/* Hero Section */}
      <div className="container d-flex flex-column flex-md-row align-items-center justify-content-between min-vh-100 px-4 mt-5">
        {/* Left Content - Push Down on Small Screens */}
        ...
        <div className="col-md-6 col-12 text-md-end text-center mt-4 mt-md-0 d-none d-md-block">
